...
![](images/glm_components.svg){fig-align="center" width="95%"}
...
-   For non-Gaussian GLMs, **DHARMa** provides much better diagnostic tools (covered after logistic regression)
:::
...
![](images/roc_auc_explained.svg){fig-align="center" width="95%"}
...
![](images/confusion_matrix_metrics.svg){fig-align="center" width="95%"}
