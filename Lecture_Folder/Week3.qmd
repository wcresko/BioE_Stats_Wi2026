...
## DRAFT: Pooled Standard Error Formula
...
-   This formula calculates the standard error of the difference between two group means, pooling variance estimates from both groups
-   When $n_1 = n_2$, the formula simplifies and yields the smallest possible standard error -- this is why **balanced designs** are preferred
-   Larger sample sizes reduce the standard error, increasing the precision of the estimated difference
:::
