...
![Tidyverse packages overview](images/week02_10_slide011.jpeg){#fig-week2-tidyverse fig-align="center" width="90%"}
...
![dplyr overview](images/week02_11_slide012.jpeg){#fig-week2-dplyr-overview fig-align="center" width="90%"}

## dplyr Workflow {.smaller}

![dplyr workflow](images/week02_12_slide013.jpeg){#fig-week2-dplyr-workflow fig-align="center" width="90%"}

## dplyr Functions {.smaller}

![dplyr functions](images/week02_13_slide014.jpeg){#fig-week2-dplyr-functions fig-align="center" width="90%"}
...
![Filter arrange select demo](images/week02_14_slide015.jpeg){#fig-week2-filter-demo fig-align="center" width="50%"}
...
![Pipe workflow step 5](images/week02_21_w1_pipes_5.jpeg){#fig-week2-pipes-5 fig-align="center" width="90%"}
...
![Grammar of graphics overview](images/week02_27_section4a_slide017.jpeg){#fig-week2-grammar-graphics fig-align="center" width="90%"}
...
![Boxplot anatomy](images/week02_28_boxplot.jpeg){#fig-week2-boxplot-anatomy fig-align="center" width="90%"}
...
![Stacked barplots for proportional data](images/week02_29_stacked_barplots_for_proportio.jpg){#fig-week2-stacked-bar fig-align="center" width="80%"}

## Rainbow Boxplots {.smaller}

![Colorful boxplots for multiple groups](images/week02_30_colorful_boxplots_for_multiple.jpg){#fig-week2-rainbow-boxplots fig-align="center" width="80%"}

## Volcano Plots {.smaller}

![Volcano plots for differential expression](images/week02_31_volcano_plots_for_differential.jpg){#fig-week2-volcano fig-align="center" width="80%"}

## Blob Plots {.smaller}

![Blob plots for categorical data](images/week02_32_blob_plots_for_categorical_dat.jpg){#fig-week2-blob-plots fig-align="center" width="80%"}
...
![Flow chart for choosing data visualization types](images/week02_33_flow_chart_for_choosing_data_v.jpeg){#fig-week2-viz-flowchart fig-align="center" width="90%"}
...
## Examples of Good, Bad, and Ugly Graphs {.smaller}

![Bad: Ticker tape parade of data](images/week02_34_bad_ticker_tape_parade_of_data.jpeg){#fig-week2-bad-ticker fig-align="center" width="75%"}

## 

![Bad: A line to no understanding](images/week02_35_bad_a_line_to_no_understanding.jpeg){#fig-week2-bad-line fig-align="center" width="75%"}

## 

![Bad: A bake sale of pie charts](images/week02_36_bad_a_bake_sale_of_pie_charts.jpeg){#fig-week2-bad-pie fig-align="center" width="75%"}

## The Best Statistical Graphic Ever Drawn {.smaller}

![Minard's map of Napoleon's Russian campaign - Edward Tufte](images/week02_37_minards_map_of_napoleons_russi.jpeg){#fig-week2-minard-map fig-align="center" width="80%"}

## Star Wars Visualization Remake {.smaller}

![Modern recreation of Minard-style data visualization](images/week02_38_modern_recreation_of_minard_st.png){#fig-week2-minard-modern fig-align="center" width="80%"}
...
![Tufte 1983](images/week02_39_tufte_1983.jpeg){#fig-week2-tufte fig-align="center" width="80%"}

## "Maximize the Data to Ink Ratio" {.smaller}

![The Economist 2006](images/week02_40_the_economist_2006.jpeg){#fig-week2-economist fig-align="center" width="80%"}

## Represent Magnitudes Honestly {.smaller}

![Rattenborg et al. 1999 Nature](images/week02_41_rattenborg_et_al_1999_nature.jpeg){#fig-week2-rattenborg fig-align="center" width="70%"}

## How NOT to Make a Figure {.smaller}

::::: columns
::: {.column width="50%"}
![](images/week02_42_section4a_slide013.jpeg){fig-align="center"}
:::

::: {.column width="50%"}
![](images/week02_43_section4a_slide014.jpeg){fig-align="center"}
:::
:::::

"Graphical excellence begins with telling the truth about the data" – Tufte 1983

## Boxplot Fundamentals {.smaller}

![Anatomy of a boxplot](images/week02_44_anatomy_of_a_boxplot.jpeg){fig-align="center" width="80%"}

## Data Distribution Shapes {.smaller}

![Comparing distribution shapes](images/week02_45_comparing_distribution_shapes.jpeg){fig-align="center" width="80%"}

## Histogram Best Practices {.smaller}

![Choosing appropriate bin widths](images/week02_46_choosing_appropriate_bin_width.jpeg){fig-align="center" width="80%"}

## Scatter Plot Essentials {.smaller}

![Relationships between variables](images/week02_47_relationships_between_variable.jpeg){fig-align="center" width="80%"}

## Time Series Visualization {.smaller}

![Displaying temporal patterns](images/week02_48_displaying_temporal_patterns.jpeg){fig-align="center" width="80%"}

## Small Multiples {.smaller}

![Faceted displays for comparison](images/week02_49_faceted_displays_for_compariso.jpeg){fig-align="center" width="80%"}

## Color in Visualization {.smaller}

![Effective use of color scales](images/week02_50_effective_use_of_color_scales.jpeg){fig-align="center" width="80%"}

## Annotation and Labels {.smaller}

![Adding context to visualizations](images/week02_51_adding_context_to_visualizatio.jpeg){fig-align="center" width="80%"}
...
![](images/week02_52_slide024.jpeg){fig-align="center" width="50%"}
...
#| fig-cap: "Comparing discrete (Poisson) and continuous (Normal) distributions"
#| fig-width: 10
#| fig-height: 5
#| echo: false
#| eval: true
...
plot(probs, qnorm(probs), type = "l", lwd = 2, col = "purple",
     main = "Quantile Function", xlab = "Probability", ylab = "x")
abline(v = 0.95, lty = 2); abline(h = qnorm(0.95), lty = 2)

# Random samples
hist(rnorm(1000), col = "lightblue", border = "white",
     main = "1000 Random Samples", xlab = "x")
```
...
![](images/week02_74_slide001.jpeg){fig-align="center" width="60%"}

## Probability of Independent Events {.smaller}

![](images/week02_75_slide002.jpeg){fig-align="center" width="100%"}
...
![](images/week02_76_slide003.jpeg){fig-align="center" width="100%"}
...
![](images/week02_79_slide011.jpeg){fig-align="center" width="90%"}

## 

![](images/week02_80_slide010.jpeg){fig-align="center" width="90%"}

## Normal PDF Equation {.smaller}

![](images/week02_81_slide012.jpeg){fig-align="center" width="50%"}

## Why is the Normal Distribution Special? {.smaller}

![](images/week02_82_slide013.jpeg){fig-align="center" width="100%"}

## Why Normal is Special in Biology {.smaller}

![](images/week02_83_slide014.jpeg){fig-align="center" width="70%"}

## Central Limit Theorem Connection {.smaller}

![](images/week02_84_slide015.jpeg){fig-align="center" width="100%"}

## Parent-Offspring Resemblance {.smaller}

![](images/week02_85_slide016.jpeg){fig-align="center" width="50%"}

## Genetic Model of Complex Traits {.smaller}

![](images/week02_86_slide017.jpeg){fig-align="center" width="90%"}

## Distribution of F2 Genotypes {.smaller}

![](images/week02_87_slide018.jpeg){fig-align="center" width="80%"}
