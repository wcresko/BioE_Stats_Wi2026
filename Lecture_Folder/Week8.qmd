...
## DRAFT: Covariance vs Correlation {.smaller}
...
# A: Positive correlation, small x range
x_a <- runif(n, 0, 12)
y_a <- 0.6 * x_a + rnorm(n, 0, 1.5)
plot(x_a, y_a, pch = 16, cex = 1.1, xlab = "x", ylab = "y",
     main = "A", xlim = c(0, 12), ylim = c(0, 11),
     cex.main = 1.8, cex.lab = 1.3)
cov_a <- round(cov(x_a, y_a), 1)
cor_a <- round(cor(x_a, y_a), 2)
legend("topleft", bty = "n", cex = 1.1,
       legend = c(paste("cov =", cov_a), paste("cor =", cor_a)))

# B: Same correlation but x scaled by 10
x_b <- x_a * 10
y_b <- y_a
plot(x_b, y_b, pch = 16, cex = 1.1, xlab = "x", ylab = "y",
     main = "B", xlim = c(0, 120), ylim = c(0, 11),
     cex.main = 1.8, cex.lab = 1.3)
cov_b <- round(cov(x_b, y_b), 1)
cor_b <- round(cor(x_b, y_b), 2)
legend("topleft", bty = "n", cex = 1.1,
       legend = c(paste("cov =", cov_b), paste("cor =", cor_b)))

# C: Strong negative correlation
x_c <- runif(n, 0, 12)
y_c <- 11 - 0.8 * x_c + rnorm(n, 0, 0.3)
plot(x_c, y_c, pch = 16, cex = 1.1, xlab = "x", ylab = "y",
     main = "C", xlim = c(0, 12), ylim = c(0, 11),
     cex.main = 1.8, cex.lab = 1.3)
cov_c <- round(cov(x_c, y_c), 1)
cor_c <- round(cor(x_c, y_c), 2)
legend("bottomleft", bty = "n", cex = 1.1,
       legend = c(paste("cov =", cov_c), paste("cor =", cor_c)))

# D: No correlation
x_d <- runif(n, 0, 12)
y_d <- runif(n, 1, 10)
plot(x_d, y_d, pch = 16, cex = 1.1, xlab = "x", ylab = "y",
     main = "D", xlim = c(0, 12), ylim = c(0, 11),
     cex.main = 1.8, cex.lab = 1.3)
cov_d <- round(cov(x_d, y_d), 2)
cor_d <- round(cor(x_d, y_d), 3)
legend("bottomright", bty = "n", cex = 1.1,
       legend = c(paste("cov =", cov_d), paste("cor =", cor_d)))
```
...
## DRAFT: LOESS Concept — Local Weighted Regression {.smaller}
